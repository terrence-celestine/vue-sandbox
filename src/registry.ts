...
export const apps: AppEntry[] = [
  { slug: 'product-sort', title: 'Product Sort', icon: ArrowDownUp, component: () => import('./components/ProductSort.vue') },
  { slug: 'tasks', title: 'Tasks', icon: ListChecks, component: () => import('./components/Tasks.vue') },
  { slug: 'books', title: 'Books', icon: BookOpen, component: () => import('./components/Dashboard.vue') },
  { slug: 'users', title: 'Users', icon: Users, component: () => import('./components/UserList.vue') },
  { slug: 'counter', title: 'Counter', icon: Calculator, component: () => import('./components/Counter.vue') },
  { slug: 'hello', title: 'Hello World', icon: Globe, component: () => import('./components/HelloWorld.vue') },
]
